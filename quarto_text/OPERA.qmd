...
[NASA ARSET - Part 2: Overview of Monitoring Floods using OPERA Surface Water Extent Based on Optical and SAR Observations](https://www.earthdata.nasa.gov/learn/trainings/monitoring-predicting-floods-using-earth-observations-planning-preparedness). For example, there is helpful guidance on _Which product is more appropriate for my application?_ at minute 33 of the presentation. You can also review the [slides](https://www.earthdata.nasa.gov/s3fs-public/2026-05/ARSET-Floods2026-part2-slides_1.pdf).
