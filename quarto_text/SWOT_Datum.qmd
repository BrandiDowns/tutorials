...
#### 1. Converting the SWOT Frame and Geoid in **Canada** - [Google Colab Section from Canadian Colleagues](https://colab.research.google.com/drive/1goHI-4-iscumrM4F2jcmixuLTwEo_23X?usp=sharing)

#### 2. Collection of hands-on SWOT data processing workshops and tutorials - [GitHub Repository of Workshops from Canadian Colleagues](https://github.com/sfoucher/SWOT-Canada/tree/main/Workshops)
